...
# Sokoban PPO Training with Qwen2.5-7B-Instruct (math prompts)
...
EXPERIMENT_NAME=${10:-"sokoban_qwen2_5_7b_inst_math_exp_$(date +"%Y%m%d_%H%M%S")"}
MODEL_PATH=${11:-"Qwen/Qwen2.5-7B-Instruct"}
GPU_MEMORY_UTILIZATION=${12:-"0.5"}
# Training control
TOTAL_TRAINING_STEPS=${13:-200}  # default 100 for Tetris

echo "=== Sokoban PPO Training with Qwen2.5-7B-Instruct (math) ==="
...
# Setup logging
mkdir -p cache
LOG_FILE="cache/sokoban_qwen2_5_7b_inst_math_exp_$(date +"%Y%m%d_%H%M%S").log"
...
# ------ Usage Examples ------
# Default: ./qwen2.5_7b_inst_math.sh
# Custom GPUs: ./qwen2.5_7b_inst_math.sh "0,1"
# Custom agent groups: ./qwen2.5_7b_inst_math.sh "0,1,2,3" "16" "32"
# Custom validation groups: ./qwen2.5_7b_inst_math.sh "0,1,2,3" "8" "16" "512,512" "1,1"
# Custom tasks: ./qwen2.5_7b_inst_math.sh "0,1,2,3" "8" "16" "256,256" "1,1" "simpleSokobanAgent" "simpleSokobanAgent,largeSokobanAgent"
# Full custom: ./qwen2.5_7b_inst_math.sh "0,1,2,3" "8" "16" "256,256,256,256" "1,1,1,1" "simpleSokobanAgent" "simpleSokobanAgent,largeSokobanAgent" 4 "my_project" "my_experiment" "Qwen/Qwen2.5-7B-Instruct"
