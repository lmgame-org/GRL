...
class AMC23Env(BaseEnv):
  ...
  def __init__(self, config, **kwargs):
    super(AMC23Env, self).__init__()
    self.config = config
    self.dataset = load_dataset(
        self.config.get("dataset_path", "math-ai/amc23"),
  ...
  def reset(self, seed=None):
    ...
    # AMC23 fields: 'question' and 'answer'
    self.current_question = question_data.get("question", "")
