...
_safe_import(lambda: __import__('grl.agents.sokobanAgent.agent', fromlist=['SokobanAgent']), 'sokobanAgent')
_safe_import(lambda: __import__('grl.agents.gsm8kAgent.agent', fromlist=['GSM8KAgent']), 'gsm8kAgent')
_safe_import(lambda: __import__('grl.agents.blocksworldAgent.agent', fromlist=['BlocksworldAgent']), 'blocksworldAgent')
_safe_import(lambda: __import__('grl.agents.tetrisAgent.agent', fromlist=['TetrisAgent']), 'tetrisAgent')
_safe_import(lambda: __import__('grl.agents.webshopAgent.agent', fromlist=['WebShopAgent']), 'webshopAgent')
_safe_import(lambda: __import__('grl.agents.birdAgent.agent', fromlist=['BirdAgent']), 'birdAgent')