...
def setup_logging():
  ...
  tee = Tee(log_path)
  sys.stdout = tee
  print(f"📝 MinervamathEnv Test log started at {datetime.now()}")
...
def get_default_config():
  cfg = MinervamathEnvConfig()
  print("✅ Using default Minervamath configuration")
...
def make_env(cfg_obj):
  return MinervamathEnv(vars(cfg_obj))
